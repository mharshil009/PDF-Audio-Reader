...
def extract_text():
    ...
    if file is None:
        ...
        text_extracted = ""
        for pageNum in range(pdfReader.numPass):
...
def Application(root):
    ...
    frame2.pack(side="top", file="y")

    #frame1 Widgets
    name1 = Label(frame1, text="PDF to Audio", fg="black", bg="blue",font = "Arial 28 bold")
    name1.pack()

    name2 = Label(frame1, text="Hear your PDF File", fg="red", bg="indigo", font="calibre 25 bold")
    name2.pack()

    #frame2 Widgets
    btn = Button(frame2, text="Select PDF File", activeforeground="red", command=extract_text(),padx="70", pady="10", fg="white", bg="black", font = "Arial 12")
    ...
    submitBtn = Button(frame2, text="Play PDF File", command=speak_text, activeforeground="red", padx="60", pady="10", fg="white", bg="black", font="Arial 12")
    submitBtn.grid(row=4, column=0, pady=65)

    stopBtn = Button(frame2, text="Stop Playing", command=stop_speaking, activeforeground="red", padx="60", pady="10", fg="white", bg="black", font="Arial 12")
